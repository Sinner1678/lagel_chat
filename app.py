...
with tab4:
    ...
    method_descriptions = {
        ...
        " تحلیل اقتصادی حقوق":"تحلیل اقتصادی حقوق به عنوان روشی نوین در روش شناسی حقوق، حقوق را به زبان اقتصاد ترجمه میکند و مفاهیم حقوقی را با ابزار و روش اقتصاد مطالعه میکند و هدفش کارایی و رشد اقتصادی است.",
